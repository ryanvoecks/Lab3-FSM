...
VL_ATTR_COLD void Vf1_clktick___024root___settle__TOP__0(Vf1_clktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clktick___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vf1_clktick___024root___eval_initial(Vf1_clktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clktick___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vclklast__TOP__clk = vlSelf->clk;
    vlSelf->__Vclklast__TOP__rst = vlSelf->rst;
}

VL_ATTR_COLD void Vf1_clktick___024root___eval_settle(Vf1_clktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clktick___024root___eval_settle\n"); );
    // Body
    Vf1_clktick___024root___settle__TOP__0(vlSelf);
}

VL_ATTR_COLD void Vf1_clktick___024root___final(Vf1_clktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clktick___024root___final\n"); );
}

VL_ATTR_COLD void Vf1_clktick___024root___ctor_var_reset(Vf1_clktick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1_clktick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1_clktick___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->f1_clktick__DOT__f1_light_tick = VL_RAND_RESET_I(1);
    vlSelf->f1_clktick__DOT__clktick__DOT__count = VL_RAND_RESET_I(16);
    vlSelf->f1_clktick__DOT__f1_fsm__DOT__current_state = 0;
    vlSelf->f1_clktick__DOT__f1_fsm__DOT__next_state = 0;
    vlSelf->__Vdly__f1_clktick__DOT__clktick__DOT__count = VL_RAND_RESET_I(16);
}
